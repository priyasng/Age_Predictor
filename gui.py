...
model=load_model('Desktop/Age_detector/Age_sex_Detection.h5')
...
# Defining Detect function which detects the age and gender of te person in image using the model
